...
# Create directories
dirs_to_create = [
    os.path.join(base_path, "src", "app", "pengeluaran"),
    os.path.join(base_path, "src", "app", "api", "pengeluaran")
]

print("Creating pengeluaran directories...")
...
# Create files
files_to_create = {
    os.path.join(base_path, "src", "app", "pengeluaran", "page.tsx"): """'use client'
...
""",
    os.path.join(base_path, "src", "app", "api", "pengeluaran", "route.ts"): """import { NextRequest, NextResponse } from 'next/server'
