#!/usr/bin/env python3
"""
Setup script to create directories and files for pengeluaran module
"""
import os
import sys
...
print("\n" + "="*60)
print("SUMMARY - All 4 items created successfully:")
print("="*60)
print("Directories:")
print("  1. src/app/pengeluaran")
print("  2. src/app/api/pengeluaran")
print("\nFiles:")
print("  3. src/app/pengeluaran/page.tsx")
print("  4. src/app/api/pengeluaran/route.ts")
print("="*60)
