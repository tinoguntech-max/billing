...
// Write files
fs.writeFileSync(path.join(__dirname, 'src/app/pengeluaran/page.tsx'), pageContent, 'utf-8');
console.log('Created src/app/pengeluaran/page.tsx');

fs.writeFileSync(path.join(__dirname, 'src/app/api/pengeluaran/route.ts'), routeContent, 'utf-8');
console.log('Created src/app/api/pengeluaran/route.ts');

console.log('Created directories and files successfully!');
