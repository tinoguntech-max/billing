...
os.makedirs("src/app/pengeluaran", exist_ok=True)
os.makedirs("src/app/api/pengeluaran", exist_ok=True)
...
'''
with open("src/app/pengeluaran/page.tsx", "w", encoding="utf-8") as f:
    f.write(pageContent)
with open("src/app/api/pengeluaran/route.ts", "w", encoding="utf-8") as f:
    f.write(routeContent)
print("Created directories and files successfully!")
